...
const UserDetail = ({ isLoggedIn, setActiveLink }) => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const response = await axios.get(`${apiUrl}/api/User/${currentUserId}`);
    ...
    navigator.geolocation.getCurrentPosition(
      async position => {
        ...
        try {
          ...
          await axios.put(
            `${apiUrl}/api/User/${currentUserId}/location`,
            { address },
  ...
  const handleSave = async () => {
    ...
    try {
      await axios.put(`${apiUrl}/api/User`, {
        ...user,
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post(`${apiUrl}/api/User/upload-avatar`, formData, {
