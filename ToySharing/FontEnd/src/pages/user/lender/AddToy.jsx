...
const AddToy = () => {
  ...
  const [price, setPrice] = useState("0"); // Đặt mặc định là "0"
  ...
  const confirmSubmit = async () => {
    ...
    if (price === "" || price === null || price === undefined) {
      priceValue = 0; // Xử lý trường hợp để trống
    ...
    try {
      ...
      formData.append("ProductValue", productValueNum);
          ...
          <Col xs={12} md={10} className="main-content">
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Form.Group controlId="price" className="mb-3">
                <Form.Label>Phí cho mượn (để trống nếu miễn phí)</Form.Label>
                <Form.Control
                  type="text"
