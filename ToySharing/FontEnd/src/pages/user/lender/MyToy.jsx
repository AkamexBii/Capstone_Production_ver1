...
const MyToy = () => {
  ...
  useEffect(() => {
    const fetchToys = async () => {
      try {
        ...
        const response = await axios.get(`${apiUrl}/api/Products/my-toys`, {
        ...
        let pendingRequests = [];
        try {
          const pendingResponse = await axios.get(`${apiUrl}/api/Requests/pending`, {
            headers: { Authorization: `Bearer ${token}` },
          });
  ...
  const handleUpdateToy = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `${apiUrl}/api/Products/${editToyData.id}`,
        formData,
        {
          headers: {
  ...
  const handleConfirm = async () => {
    try {
      ...
      await axios.delete(`${apiUrl}/api/Products/${selectedToyId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
